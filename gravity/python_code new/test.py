...
handler = pygame_classes.handler([(10e100, 0, 0), *[[np.random.randint(10_000, 1_000_000), np.random.randint(-500, 500), np.random.randint(-500, 500)] for p in range(constants.BODIES)]])
